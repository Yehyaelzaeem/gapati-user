...
Future<void> init() async {
  ...
  getIt.registerLazySingleton(() => LocalAuthCubit( getProfileUseCase:  getIt(), isUserLoginUseCase: getIt()));
  ...
  getIt.registerLazySingleton(() => CheckOutCubit(addAddressUseCase: getIt(), mainAddressUseCase: getIt(), checkOutUseCase:  getIt(),));
