...
class RestaurantsUseCase implements BaseUseCase<RestaurantsNearestModel>{
  ...
  Future<ResponseModel> call(LatLng latLng) async {
    return BaseUseCaseCall.onGetData<RestaurantsNearestModel>( await repository.getRestaurantsNearest(latLng), onConvert,tag: 'RestaurantsUseCase');
  }
