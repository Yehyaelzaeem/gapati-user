...
class CustomAddCartButton extends StatelessWidget {
  const CustomAddCartButton({super.key, required this.categoriesItemsModelData, required this.storeName, this.width, this.height, this.color, this.type});
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<CartCubit, CartState>(
      ...
      builder: (context, state) {
        ...
        if(type=='cart'){
          var pCart =
          cubit.products.firstWhere((CategoryItemsData element) =>
