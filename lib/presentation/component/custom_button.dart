    ...
    return SizedBox(
      ...
      child: TapEffect(
        ...
        child: MaterialButton(
          color: _isOutlined ? Colors.transparent : (_color ?? Theme.of(context).primaryColor),
          ...
          child: _loading
              ...
              : _title != null
                  ? Center(
                      child: Text(
                        _title!,
                        style: const TextStyle().regularStyle(fontSize: _fontSize ?? 14).customColor(_textColor ?? Colors.white),
                      ),
                    )
