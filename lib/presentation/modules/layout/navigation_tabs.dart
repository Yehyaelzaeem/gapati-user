...
import 'package:cogina/presentation/modules/layout/screens/wallet/wallet_screen.dart';
...
const List<NavigationTab> kTabs = <NavigationTab>[
  ...
  NavigationTab(
    ...
    image: Assets.svgMoreNotificationIcon ,
    unSelectIcon:Icons.account_balance_wallet_outlined  ,
    selectIcon:  Icons.account_balance_wallet,
    initialRoute: WalletScreen(),
